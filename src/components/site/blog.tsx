      ...
      <div className="container mx-auto max-w-7xl px-6 relative">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-14">
          {blogPosts.map((post, i) => (
            <motion.article
              ...
              className="group rounded-2xl overflow-hidden bg-white border border-slate-200 hover:border-[#0056D2]/30 hover:shadow-xl transition-all flex flex-col"
            >
              <div className="relative aspect-[16/9] bg-gradient-to-br from-[#0B1F3A] via-[#0056D2] to-[#4A90E2] overflow-hidden">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <h3 className="font-[family-name:var(--font-poppins)] text-lg font-bold text-[#0B1F3A] mb-3 leading-tight group-hover:text-[#0056D2] transition-colors">
                  {post.title}
                </h3>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#0056D2] hover:text-[#004BB0] mt-auto"
                >
                  Read article
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            <div>
              <h3 className="font-[family-name:var(--font-poppins)] text-xl font-bold text-[#0B1F3A]">
                Browse by category
              </h3>
              <p className="text-sm text-[#5A6B82] mt-1">12 categories. 200+ articles. Find what you need.</p>
            </div>
            <Button variant="outline" className="border-[#0056D2]/30 text-[#0056D2] hover:bg-[#0056D2] hover:text-white">
              View all articles
          ...
          <div className="flex flex-wrap gap-2">
            {blogCategories.map((cat) => (
              <a
                ...
                href="#blog"
                onClick={(e) => e.preventDefault()}
                className="group inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#F4F6FA] hover:bg-[#0056D2] text-[#0B1F3A] hover:text-white text-sm font-medium transition-colors"
              >
                {cat.name}
