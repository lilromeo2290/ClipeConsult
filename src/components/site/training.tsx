...
export function Training() {
  return (
    <section id="training" className="relative py-20 lg:py-28 bg-white overflow-hidden">
      ...
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 h-96 w-96 rounded-full bg-[#1B2A5C]/5 blur-3xl" aria-hidden />
      ...
      <div className="container mx-auto max-w-7xl px-6 relative">
          ...
          <div className="lg:col-span-5">
            ...
            >
              {[
                ...
                <div key={s.label} className="rounded-xl p-4 bg-gradient-to-br from-[#1B2A5C] to-[#1B2A5C] text-white text-center">
                  <s.icon className="h-5 w-5 mx-auto mb-2 text-[#E31E24]" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {trainingCourses.map((course, i) => (
            <motion.div
              ...
              className="group rounded-xl p-5 bg-white border border-slate-200 hover:border-[#1B2A5C]/30 hover:shadow-lg transition-all flex flex-col"
            >
              <div className="flex items-center justify-between mb-4">
                <span className="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-[#EEF1F8] text-[#1B2A5C] group-hover:bg-[#1B2A5C] group-hover:text-white transition-colors">
                  <GraduationCap className="h-5 w-5" />
                </span>
                <span className="text-[10px] font-mono text-[#5A6B82]/50">0{i + 1}</span>
              </div>
              <h3 className="font-[family-name:var(--font-poppins)] text-base font-bold text-[#1B2A5C] mb-2 leading-tight group-hover:text-[#1B2A5C] transition-colors">
                {course.title}
              </h3>
              ...
              <div className="space-y-2 pt-4 border-t border-slate-100">
                <div className="flex items-center gap-2 text-[11px] text-[#5A6B82]">
                  <BarChart3 className="h-3.5 w-3.5 text-[#1B2A5C]" />
                  <span>{course.level}</span>
                </div>
                <div className="flex items-center gap-2 text-[11px] text-[#5A6B82]">
                  <Clock className="h-3.5 w-3.5 text-[#1B2A5C]" />
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.5 }}
          className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 p-6 rounded-2xl bg-[#1B2A5C] text-white text-center sm:text-left"
        >
          <div>
          ...
          <Button
            ...
            className="bg-white text-[#1B2A5C] hover:bg-white/90 flex-shrink-0 group"
          >
