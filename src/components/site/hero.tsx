            ...
            <div className="flex gap-5 animate-marquee w-max">
              {[...showcases, ...showcases].map((s, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex-shrink-0 w-[clamp(340px,calc((100vw-6rem)/3.4),440px)] rounded-xl overflow-hidden border border-white/10 bg-white/5 hover:border-[#E31E24]/50 hover:shadow-xl transition-all"
