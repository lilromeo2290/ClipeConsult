...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Visionary leader and senior engineer who founded Clipe Consult to bring enterprise-grade technology to Ghanaian businesses. Sets company strategy while still actively architecting solutions for key clients.",
    initials: "RD",
  ...
  },
  {
    name: "Gifty Dravie",
    role: "Director",
    bio: "Provides strategic direction and oversees operations across the company. Ensures every project aligns with Clipe Consult's mission of delivering reliable, innovative and value-driven technology solutions.",
    initials: "GD",
  ...
  },
  {
    ...
    bio: "Keeps Clipe Consult running smoothly behind the scenes — managing administration, finance, procurement and vendor relationships so our technical team can focus entirely on client success.",
    initials: "SD",
